...
llm = HuggingFaceLLM(model_name="/root/autodl-tmp/Qwen/Qwen1.5-1.8B-Chat",
               tokenizer_name="/root/autodl-tmp/Qwen/Qwen1.5-1.8B-Chat",
...
#从指定目录读取文档，将数据加载到内存
documents = SimpleDirectoryReader("/root/autodl-tmp/demo_19/data01").load_data()
# print(documents)
...
rsp = query_engine.query("ChatGPT是什么？")
print(rsp)